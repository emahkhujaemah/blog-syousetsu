            ...
            <div class="col-md-4 mb-3">
                <div class="card">                    
                    ...
                    <div class="card-body">
                        ...
                        <small class="text-muted">
                            <p>Author: {{ $posts[0]["author"] }} <br> Write By <a href="/writers/{{$post->writer->username}} " class="text-decoration-none">{{ $post->writer->name }}</a> {{$posts[0]->created_at->diffForHumans()}}
                            </p>
                        </small>
